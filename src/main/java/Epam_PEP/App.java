...
public class App {
    public static void main( String[] args) throws IOException {
        ...
        do {
            ...
            System.out.println("Press 1 to find the average of List of Integers");
            System.out.println("Press 2 to filter Strings having length = 3 and starting with a");
            System.out.println("Press 3 to filter Pallindrome Strings");
